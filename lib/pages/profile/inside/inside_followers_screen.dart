...
class InsideFollowersScreen extends StatefulWidget {
  final String userID;
  final String username;
  final int noOfFollowers;
  final String name;
  const InsideFollowersScreen(
      {super.key,
  ...
  @override
  State<InsideFollowersScreen> createState() => _InsideFollowersScreenState();
}

class _InsideFollowersScreenState extends State<InsideFollowersScreen> {
  ...
  void fetchFollowers(bool next, context) async {
    ...
    if (next) {
      ...
      followingRef = await firestore
          .collection('users/${widget.userID}/myFollowers')
