...
class NewPollsTab extends StatefulWidget {
  const NewPollsTab({super.key});

  @override
  State<NewPollsTab> createState() => _NewPollsTabState();
}

class _NewPollsTabState extends State<NewPollsTab> {
